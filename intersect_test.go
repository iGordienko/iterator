...
func TestInter_NextSomeFor2RandomArrays(t *testing.T) {
	a0 := randArray(3000)
	a1 := randArray(2000)
	//a0 := randArray(8)
	//a1 := randArray(5)
...
func TestInter_SameArrayInFourIntersections(t *testing.T) {
	a0 := randArray(3000)
	a0Copy := copyArray(a0)
	//a0 := []int{0, 1, 3}
	//a1 := []int{1, 3}
	expectedIntersect := copyArray(arrays.Intersect(a0, a0))
	it := NewInterIter(NewInterIter(NewArrayIter(a0), NewArrayIter(a0)), NewInterIter(NewArrayIter(a0), NewArrayIter(a0)))
	it.Reset()
	out := make([]int, 0)
	for {
		if v, ok := it.NextSome(); !ok {
...
func TestInter_DoubleIntercetionOfTwoArrays(t *testing.T) {
	a0 := randArray(3000)
	a1 := randArray(2000)
	a0Copy := copyArray(a0)
	a1Copy := copyArray(a1)
	...
	//a1 := []int{1, 3}
	expectedIntersect := copyArray(arrays.Intersect(a0, a1))
	it := NewInterIter(NewInterIter(NewArrayIter(a0), NewArrayIter(a1)), NewInterIter(NewArrayIter(a0), NewArrayIter(a1)))
	it.Reset()
	out := make([]int, 0)
	for {
		if v, ok := it.NextSome(); !ok {
...
func TestInter_BigThreeArrays(t *testing.T) {
	a0 := randArray(600000)
	a1 := randArray(400000)
	a2 := randArray(200000)
	a0Copy := copyArray(a0)
...
func BenchmarkInter_Next(b *testing.B) {
	a0 := randArray(300000)
	a1 := randArray(200000)
	a2 := randArray(100000)
	it := NewInterIter(NewInterIter(NewArrayIter(a0), NewArrayIter(a1)), NewArrayIter(a2))
...
func BenchmarkInter_NextSome(b *testing.B) {
	a0 := randArray(300000)
	a1 := randArray(200000)
	a2 := randArray(100000)
	it := NewInterIter(NewInterIter(NewArrayIter(a0), NewArrayIter(a1)), NewArrayIter(a2))
